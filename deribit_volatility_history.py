...
def retrieve_historic_data(start, end, currency, timeframe):
    msg = \
        {
            "jsonrpc": "2.0",
            "id": 833,
...
if __name__ == '__main__':
    ...
    currency = "BTC"
    timeframe = '3600'
    json_resp = retrieve_historic_data(start, end, currency, timeframe)
...
df.to_csv(r'C:\Users\lucas\Desktop\Fintech Bootcamp\Project#2\Volatility30Days.csv.csv', index = False)